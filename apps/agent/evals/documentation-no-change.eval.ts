...
export default defineEval({
  ...
  async test(t) {
    await t.send(
      "Use documentation_draft to prepare the documentation repository and immediately inspect_diff without editing anything. Briefly report the no-change result. Do not publish.",
    );
    t.succeeded();
    t.noFailedActions();
