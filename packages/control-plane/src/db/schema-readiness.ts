...
import type { DocsAgentDatabase } from "./client.js";
import { schema } from "./schema.js";

export const DOCS_AGENT_SCHEMA_MIGRATION_COUNT = 13;
export const DOCS_AGENT_SCHEMA_LATEST_MIGRATION_AT = 1783818459285;
